...
const COPY = {
  ...
  en: {
    region: 'URL MCP activation',
    heading: 'Verify URL MCP',
...
function activationTarget(raw: McpDefinition): ActivationTarget | null {
  ...
  if (!installationId
    ...
    || definition.provenance.installedDigest === null
    || definition.sourceUrl === null
    || definition.sourceUrl !== definition.provenance.sourceUrl) return null;
  return {
    definition,
    installationId,
