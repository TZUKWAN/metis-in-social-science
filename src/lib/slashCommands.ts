...
export const SLASH_COMMANDS: SlashCommand[] = [
  ...
  { name: 'paper', description: '快速添加文献到当前项目（无项目时仅入库）', hasArg: true, requiresArg: true, argPlaceholder: '输入论文标题或 DOI…' },
  { name: 'note', description: '快速添加笔记到资料库', hasArg: true, requiresArg: true, argPlaceholder: '输入笔记内容…' },
