...
-- ── Outcomes 2.0（任务书 Phase 1：draft/snapshot/revision/memory/review/graph）──
-- 铁律：Draft/Snapshot/Revision 都不是 Version；只有保存版本与 Office sync 写 outcome_versions。
