...
CREATE TABLE IF NOT EXISTS content_charters (id TEXT PRIMARY KEY, name TEXT NOT NULL, scope TEXT NOT NULL DEFAULT 'global', project_id TEXT, definition_json TEXT NOT NULL DEFAULT '{}', is_active INTEGER NOT NULL DEFAULT 0, created_at INTEGER NOT NULL, updated_at INTEGER NOT NULL);
CREATE INDEX IF NOT EXISTS idx_content_charters_scope ON content_charters(scope, project_id);
