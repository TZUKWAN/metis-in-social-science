...
export { parseFontTable } from './font-table.js'
export { parseDocx, styleRunFormat, type ParseExtras } from './parse.js'
export {
  saveDocx,
...
export { decodeSymbolChar, decodeSymbolText, isSymbolFont, toSymbolPua } from './symbol-fonts.js'
export {
  bulletMarkerScale,
