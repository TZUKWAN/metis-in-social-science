 ...
 */
import type { Paragraph, Slide, TextElement } from './types.js'
import { generateParagraphXml } from './generate.js'
import { materializeSlide, type OpenedPptx } from './index.js'
