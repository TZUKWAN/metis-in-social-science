...
import { PackageArchive, relsPathFor, resolveTarget, type Relationship } from './zip.js'
import { parseClrMap, parseTheme, type Theme } from './theme.js'
import {
  parseSlide,
  parseDecorations,
  parseBackground,
...
import { parsePlaceholderMap, parseMasterTextStyles, parseDefaultTextStyle } from './placeholder.js'
import {
...
import { BLANK_SLIDE_XML } from './blank.js'
import { escapeXmlAttr } from './xml-utils.js'
import { elementSpid } from './animation.js'
import { ensureCreationId } from './identity.js'
import { listMasterParts, parseMasterPart } from './master-edit.js'
import type {
  Paragraph,
  PPrDirty,
  SlideDeck,
...
import { patchTableStyleXml, ensureTableStyleXml, type TableStyleEdit } from './table-edit.js'
import { buildChartSpaceXml, type NewChartKind, type NewChartOptions } from './chart-insert.js'
import { parseLayoutPlaceholders, placeholderSpXml, prepareInsertSlideWithLayout } from './layout.js'
import {
  chooseLayout,
  collectSlideBundle,
  importSourceLayout,
  ...
  type SlideBundle,
} from './slide-transfer.js'
import { moveSlide } from './sections.js'
import { cleanupSupersededSlideResources, removePartWithOwnedResources } from './resource-cleanup.js'

export * from './types.js'
export { cleanupSupersededSlideResources }
export type { ResourceCleanupStats } from './resource-cleanup.js'
export {
  animClassOf,
  buildTimingXml,
  DEFAULT_MOTION_PATH,
...
export { PackageArchive } from './zip.js'
export { scanSlide, type SlideScan, type SpElement } from './scan.js'
export {
  parseSlide,
  parseDecorations,
  DEFAULT_BODY_INSETS,
...
export { tableRowGridCols } from './table-grid.js'
export { parseTheme, parseClrMap, resolveSchemeColor, type Theme } from './theme.js'
export {
  patchTextElementXml,
  patchElementXfrm,
  patchElementFill,
...
export { createBlankPptx } from './blank.js'
export {
  elementCNvPrId,
  elementDurableId,
  ensureCreationId,
...
export { promoteSlideBackground, isBackgroundLikeElement } from './background-promote.js'
export {
  applyThemeToArchive,
  buildColorMap,
...
export { escapeXmlText, escapeXmlAttr } from './xml-utils.js'
export {
  extractFormat,
  applyFormat,
  type CopiedFormat,
...
} from './format-brush.js'
export { listSlideLayouts, type SlideLayoutInfo, type LayoutPlaceholder } from './layout.js'
export {
  BUILTIN_LAYOUTS,
...
export { resolveFontRef } from './theme.js'
export { resolveColorNode, applyColorMods } from './color.js'
export {
  parseChartXml,
  type ChartModel,
  type ChartSeries,
...
export { parseChartExXml } from './chartex.js'
export { getSlideNotes, setSlideNotes, notesPathForSlide, unescapeXml } from './notes.js'
export {
  getSlideComments,
  addSlideComment,
  deleteSlideComment,
...
export { applyHeaderFooter, readHeaderFooter, type HeaderFooterOptions } from './headerfooter.js'
export {
  getSections,
  setSections,
  addSection,
...
export { listMasterParts, parseMasterPart, type MasterPartInfo } from './master-edit.js'
