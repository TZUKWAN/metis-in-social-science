 ...
 */
import type { EmuRect, Paragraph, PictureElement, Slide, SlideElement, TextElement } from './types.js'
import { generateParagraphXml, generateXfrmXml } from './generate.js'
import { creationIdXml, escapeXmlAttr } from './xml-utils.js'
import { relsPathFor } from './zip.js'
import type { OpenedPptx } from './index.js'
import { cleanupDeletedElementResources } from './resource-cleanup.js'
